...
for _,enemy_id in pairs(EntityGetInRadiusWithTag( pos_x, pos_y, range, "reap_marked")) do
	...
	if distance > range * 0.8 then
		GameCreateSpriteForXFrames( "mods/moldos_arsenal/files/entities/items/tome/radar_faint.png", indicator_x, indicator_y, true, 0, 0, 1, true )
	elseif distance > range * 0.5 then
		GameCreateSpriteForXFrames( "mods/moldos_arsenal/files/entities/items/tome/radar_medium.png", indicator_x, indicator_y, true, 0, 0, 1, true )
	else
		GameCreateSpriteForXFrames( "mods/moldos_arsenal/files/entities/items/tome/radar_strong.png", indicator_x, indicator_y, true, 0, 0, 1, true )
	end
end
