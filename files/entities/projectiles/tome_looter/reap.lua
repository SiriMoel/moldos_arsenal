...
function death(damage_type_bit_field, damage_message, entity_thats_responsible, drop_items)
    ...
    if dodrop == 2 then
        ...
        if which == 1 then
            ...
            EntityLoad("mods/moldos_arsenal/files/entities/items/soulchest/chest.xml", x, y)
        end
        if which == 2 then
            GamePrint("Key dropped!")
            EntityLoad("mods/moldos_arsenal/files/entities/items/soulchest/key/key.xml", x, y)
        end
    end
end